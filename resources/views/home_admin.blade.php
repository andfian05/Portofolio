      ...
      <header class="app-header">
        ...
        <div class="container-fluid">
          <div class="py-6 px-6 text-center">
            <p class="mb-0 fs-4">Design and Developed by <a href="https://www.linkedin.com/in/fianfi/" target="_blank" class="pe-1 text-primary text-decoration-underline">Andika Alifian</a></p>
          </div>
        </div>
