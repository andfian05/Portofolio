...
@section('content')
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-3">Formulir Halaman Tambah Data Pengalaman Diri</h5>
              ...
              <div class="card">
                ...
                <div class="alert alert-secondary text-center" role="alert">
                  Form Tambah Data Pengalaman Diri 
                </div>
                  <form action="{{ route('admin.experience.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="paragraf_exp" class="form-control" id="" aria-describedby="" value="">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">First Years Of Experience</label>
                        <input type="date" name="first_years_exp" class="form-control" id="" aria-describedby="" value="">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Last Years Of Experience</label>
                        <input type="date" name="last_years_exp" class="form-control" id="" aria-describedby="" value="">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Description Experience (500)</label>
                        <textarea name="desc_exp" class="form-control" cols="15" rows="15"></textarea>
                    </div>
