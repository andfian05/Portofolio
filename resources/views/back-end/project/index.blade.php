...
@section('content')
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
            <h5 class="card-title fw-semibold mb-3">Formulir Halaman Proyek</h5>
              ...
              <div class="card-body">
                  ...
                  <ul class="list-unstyled d-flex align-items-center mb-0">
                    ...
                    <li class="me-2"><a href="{{ route('admin.project.create') }}" class="btn btn-primary">Tambah Data</a></li>
                              ...
                              <table class="table">
                                ...
                                <tbody class="table-group-divider">
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td data-title="Description"><img src="" style="width:150px" alt=""></td> -->
                                            
                                            <td data-title="Paragraf">{{ $project->paragraf_portfolio }}</td>
                                            <td data-title="Desc">{{ $project->desc_portfolio }}</td>
                                            
                                           
                                            <th class="d-flex justify-content-center">
                                                <a class="btn btn-secondary btn-sm me-2"
                                                    href="{{ route('admin.project.show', $project->id) }}"> Detail</a>
                                                <a class="btn btn-warning btn-sm me-2"
                                                    href="{{ route('admin.project.edit', $project->id) }}"> Update</a>
