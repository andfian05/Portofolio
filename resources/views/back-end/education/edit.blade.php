            ...
            <div class="card-body">
              ...
              <!-- <div class="card"> -->
                ...
                <div class="alert alert-secondary text-center" role="alert">
                  ...
                  <form action="{{route('admin.education.update', $educs->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="paragraf_edu" class="form-control" id="" aria-describedby="" value="{{ old('paragraf_edu') ? old('paragraf_edu') : $educs->paragraf_edu }}">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Description Education</label>
                        <textarea name="desc_edu" class="form-control" cols="15" rows="15">{!! old('desc_edu') ? old('desc_edu') : $educs->desc_edu !!}</textarea>
                    </div>
