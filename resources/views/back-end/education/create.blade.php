...
@section('content')
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-3">Formulir Halaman Tambah Data Pendidikan</h5>
                ...
                <div class="alert alert-secondary text-center" role="alert">
                  ...
                  <form action="{{ route('admin.education.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="paragraf_edu" class="form-control" id="" aria-describedby="" value="">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Description Education (500)</label>
                        <textarea name="desc_edu" class="form-control" cols="15" rows="15"></textarea>
                    </div>
                    
                    <div class="mb-3">
                        <label for="" class="form-label">Uploading Image Card (500 x 500)</label>
                        <input type="file" name="image_edu" class="form-control" id="" aria-describedby="" value="">
